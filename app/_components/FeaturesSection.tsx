...
export default function FeaturesSection() {
  ...
  const [card1Ref, card1InView] = useInView({ threshold: 0.3, triggerOnce: true });
  const [card2Ref, card2InView] = useInView({ threshold: 0.3, triggerOnce: true });
  const [card3Ref, card3InView] = useInView({ threshold: 0.3, triggerOnce: true });
  const [card4Ref, card4InView] = useInView({ threshold: 0.3, triggerOnce: true });
  const [card5Ref, card5InView] = useInView({ threshold: 0.3, triggerOnce: true });
  const [card6Ref, card6InView] = useInView({ threshold: 0.3, triggerOnce: true });
