...
export default function Footer() {
  return (
    <footer className="mb-14 px-6 md:px-10">
      <div className="w-full max-w-[1210px] mx-auto mb-14">
        {" "}
        ...
        <hr className="border-t border-[#BBBBBB]" />
        <div className="flex flex-col md:flex-row flex-wrap gap-8 justify-between mt-5 md:mt-10 mb-14">
          <div>
            <Logo />
          ...
          <div className="flex justify-between md:gap-x-[67px]">
            <div>
              {" "}
